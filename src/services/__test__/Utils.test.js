describe('UtilsService', () => {
    ...
    it('returns a randomized list of provided values, ensuring a particular value is present', () => {
        const randomValues = [ 0.8106155395507813, 0.7146610021591187, 0.06898759305477142, 0.3258082866668701, 0.11168600618839264, 0.05064991116523743, 0.34461453557014465, 0.20475636422634125, 0.5583593249320984, 0.9148363471031189 ];
        let randomValueIndex = 0;
        global.Math.random = jest.fn(() => randomValues[randomValueIndex++ % randomValues.length]);
