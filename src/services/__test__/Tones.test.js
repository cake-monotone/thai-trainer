...
describe('Tones service', () => {
  ...
  it('converts a simple thai word to constituent parts', () => {
    ...
    expect(getComponents('มา')).toEqual([['ม', TONE_CLASS_LOW], ['า']]);
  ...
  it('converts a simple thai word to constituent parts', () => {
    ...
    expect(getComponents('ต่ำ')).toEqual([['ต่ำ', TONE_CLASS_MID]]);
    ...
    expect(getComponents('จ๊ะ')).toEqual([['จ๊', TONE_CLASS_MID], ['ะ']]);
  });
  it('applies tone rules by characcter', () => {
    ...
    ).toEqual(TONE_MID); // BOX 1 (open + long)
    expect(
      getTone({
        character: 'น',
        length: TONE_VOWEL_LONG,
    ...
    ).toEqual(TONE_MID); // BOX 2 (sonorant + open)
    expect(
      getTone({
        character: 'น',
    ...
    ).toEqual(TONE_HIGH); // BOX 3 (open + short)
    expect(
      getTone({
        character: 'ร',
        length: TONE_VOWEL_SHORT,
    ...
    ).toEqual(TONE_HIGH); // BOX 4 (closed + short)
    expect(
      getTone({
        character: 'ล',
        length: TONE_VOWEL_LONG,
    ...
    ).toEqual(TONE_FALLING); // BOX 5 (closed + long)
    ...
    ).toEqual(TONE_FALLING); // BOX 1 (open + long)
    expect(
      getTone({
        character: 'น',
        length: TONE_VOWEL_LONG,
    ...
    ).toEqual(TONE_FALLING); // BOX 2 (sonorant + open)
    expect(
      getTone({
        character: 'น',
        length: TONE_VOWEL_SHORT,
    ...
    ).toEqual(TONE_FALLING); // BOX 3 (open + short)
    expect(
      getTone({
        character: 'ร',
        length: TONE_VOWEL_SHORT,
    ...
    ).toEqual(TONE_FALLING); // BOX 4 (closed + short)
    expect(
      getTone({
        character: 'ล',
        length: TONE_VOWEL_LONG,
    ...
    ).toEqual(TONE_HIGH); // BOX 1 (open + long)
    expect(
      getTone({
        character: 'น',
        length: TONE_VOWEL_LONG,
    ...
    ).toEqual(TONE_HIGH); // BOX 2 (sonorant + open)
    expect(
      getTone({
        character: 'น',
        length: TONE_VOWEL_SHORT,
    ...
    ).toEqual(TONE_HIGH); // BOX 5 (closed + long)
    ...
    ).toEqual(TONE_LOW); // BOX 3 (open + short)
    expect(
      getTone({
        character: 'บ',
        length: TONE_VOWEL_SHORT,
    ...
    ).toEqual(TONE_LOW); // BOX 4 (closed + short)
    expect(
      getTone({
        character: 'ป',
        length: TONE_VOWEL_LONG,
    ...
    ).toEqual(TONE_LOW); // BOX 5 (closed + long)
    ...
    ).toEqual(TONE_LOW); // BOX 1 (open + long)
    expect(
      getTone({
        character: 'จ',
        length: TONE_VOWEL_LONG,
    ...
    ).toEqual(TONE_LOW); // BOX 2 (sonorant + open)
    expect(
      getTone({
        character: 'ด',
        length: TONE_VOWEL_SHORT,
    ...
    ).toEqual(TONE_RISING); // BOX 1 (open + long)
    expect(
      getTone({
        character: 'จ',
        length: TONE_VOWEL_LONG,
    ...
    ).toEqual(TONE_RISING); // BOX 2 (sonorant + open)
    expect(
      getTone({
        character: 'ด',
        length: TONE_VOWEL_SHORT,
    ...
    ).toEqual(TONE_RISING); // BOX 3 (open + short)
    expect(
      getTone({
        character: 'บ',
        length: TONE_VOWEL_SHORT,
    ...
    ).toEqual(TONE_RISING); // BOX 4 (closed + short)
    expect(
      getTone({
        character: 'ป',
        length: TONE_VOWEL_LONG,
    ...
    ).toEqual(TONE_RISING); // BOX 5 (closed + long)
