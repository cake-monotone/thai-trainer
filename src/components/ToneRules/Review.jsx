    ...
    return (
      <div className="review">
        ...
        <Hint {...this.props} title="Hint">
          <p>
            Consider learning mid-class rules first. They make a great
            foundation! The other classes essentially &quot;borrow&quot;
            something from mid-class rules.
          </p>
          <p>
            On the other hand, tone-leading low-class characters are more
            frequent than mid- and high-class characters (according to my
            studies: 42% vs. 35% &amp; 23%.)
          </p>
        </Hint>
        ...
        <table className={tableClasses}>
          ...
          <tbody>
            <tr>
              ...
              <td colSpan="3" className="c-1 c-4 c-9">
                R
              </td>
              <td colSpan="3" className="c-2 c-3 c-4 c-9">
                L
              </td>
            </tr>
            <tr>
              ...
              <td colSpan="3" className="c-2 c-3 c-4 c-8">
                L
              </td>
            </tr>
            <tr>
              ...
              <td colSpan="2" className="c-2 c-3 c-4 c-7">
                H
              </td>
